...
<div x-data="{ hideModal: @entangle('hideModal') }">
    <div x-cloak class="aud-app-modal"  :class="{'reveal-modal': hideModal }" tabindex="-1">
        <div class="aud-app-modal-dialog aud-app-modal-dialog-centered aud-app-modal-dialog-scrollable modal-lg">
            <div class="aud-app-modal-content">
                <div class="aud-app-modal-header">
                    ...
                    <button x-on:click="$wire.CloseModal()" type="button" class="aud-app-close" aria-label="Close">
...
{{--                    <button x-on:click="hideModal=true" type="button" class="btn btn-secondary">Close</button>--}}
    ...
    <div x-cloak class="aud-app-modal-backdrop" :class="{'reveal-modal': hideModal }"></div>
</div>
