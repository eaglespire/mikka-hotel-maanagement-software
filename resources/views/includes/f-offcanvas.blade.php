<div class="offcanvas-menu">
    ...
    <div id="cssmenu3" class="menu-one-page-menu-container">
        <ul id="menu-one-page-menu-2" class="menu">
            ...
            <li class="menu-item menu-item-type-custom menu-item-object-custom"><a href="">Our Rooms</a></li>
            <li class="menu-item menu-item-type-custom menu-item-object-custom"><a href="">Facilities</a></li>
    ...
    <div id="cssmenu2" class="menu-one-page-menu-container mt-100">
