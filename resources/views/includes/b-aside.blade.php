            ...
            <ul class="metismenu" id="side-menu">
                ...
                <li>
                    <a href="javascript:void(0);" class="waves-effect"><i class="ti-package"></i> <span> Rooms <span
                                class="float-right menu-arrow"><i class="mdi mdi-chevron-right"></i></span> </span> </a>
                    <ul class="submenu">
                        <li><a href="{{ route('b-add-room') }}">Add Room</a></li>
                        <li><a href="{{ route('b-rooms') }}">All Rooms</a></li>
                        <li><a href="{{ route('b-add-feature') }}">Add Feature</a></li>
                ...
                <li>
                    <a href="javascript:void(0);" class="waves-effect"><i class="ti-pie-chart"></i><span> Employees <span
                                class="float-right menu-arrow"><i class="mdi mdi-chevron-right"></i></span> </span></a>
                    <ul class="submenu">
                        <li><a href="hh.html">All Employees</a></li>
                        <li><a href="r.html">Add Employee</a></li>
                    </ul>
                </li>
