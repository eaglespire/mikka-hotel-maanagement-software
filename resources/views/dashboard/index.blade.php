...
@section('content')
    @viteReactRefresh
    @vite('resources/js/components/Greeting.jsx')
    <div class="row">
        <div class="col-12">
            <div id="greeting" data-fullname="{{ auth()->user()->fullname }}"></div>
        </div>
                    ...
                    <ol class="activity-feed">
                        ...
                        <li class="feed-item">
                            <div class="feed-item-list">
                                ...
                                <span class="activity-text">At vero eos et accusamus et iusto odio dignissimos ducimus qui deleniti atque...<a
                                        href="#" class="text-success">Read more</a></span>
                            </div>
                        </li>
                        <li class="feed-item">
                            <div class="feed-item-list">
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="text-muted mb-5">" Everyone realizes why a new common language would be desirable one could refuse
                                to pay expensive translators it would be necessary. "</p>
                            <div class="float-right mt-2">
                                <a href="#" class="text-primary">
                                    <i class="mdi mdi-arrow-right h5"></i>
                                </a>
                            </div>
                            <h6 class="mb-0"><img src="/assets/images/users/user-3.jpg" alt="" class="thumb-sm rounded-circle mr-2"> James
                                Athey</h6>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div>
                                        <img src="/assets/images/users/user-2.jpg" alt="" class="thumb-md rounded-circle mr-2"> Philip
                                        Smead
                                    </div>
                                </td>
                                <td>15/1/2018</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div>
                                        <img src="/assets/images/users/user-3.jpg" alt="" class="thumb-md rounded-circle mr-2"> Brent
                                        Shipley
                                    </div>
                                </td>
                                <td>16/1/2019</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div>
                                        <img src="/assets/images/users/user-4.jpg" alt="" class="thumb-md rounded-circle mr-2"> Robert
                                        Sitton
                                    </div>
                                </td>
                                <td>17/1/2019</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div>
                                        <img src="/assets/images/users/user-5.jpg" alt="" class="thumb-md rounded-circle mr-2"> Alberto
                                        Jackson
                                    </div>
                                </td>
                                <td>18/1/2019</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div>
                                        <img src="/assets/images/users/user-6.jpg" alt="" class="thumb-md rounded-circle mr-2"> David
                                        Sanchez
                                    </div>
                                </td>
                                <td>19/1/2019</td>
